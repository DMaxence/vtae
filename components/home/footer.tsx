...
export function Footer() {
  ...
  const createHref = (href: string) =>
    domain === "vtae.xyz" ? href : `https://vtae.xyz${href}`;

  return (
    <footer className="z-10 border-t border-gray-200 bg-white/50 py-8 backdrop-blur-lg dark:border-slate-700 dark:bg-black/50">
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            >
              ...
              <Image
                alt="Vtae"
                className="relative object-contain dark:invert"
                width={80}
                height={30}
                src="/logo.png"
              />
